...
const FriendsActivity = () => {
	...
	useEffect(() => {
		...
		if (users.length > 0) {
			...
			console.log("First user imageUrl:", users[0].imageUrl);
		}
	}, [users]);
									...
									<div className='relative'>
										<Avatar className='size-10 border border-zinc-800'>
											<img 
												...
												onError={(e) => {
													console.log("Regular img failed to load:", user.imageUrl);
													console.log("Error event:", e);
												}}
												onLoad={() => {
													console.log("Regular img loaded successfully:", user.imageUrl);
												}}
											/>
